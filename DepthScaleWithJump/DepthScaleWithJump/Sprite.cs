...
namespace DepthScaleWithJump
{
    public abstract class Sprite
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Vector2 cameraPosition)
        {
            ...
            spriteBatch.Draw(_texture, drawPosition, Location, Color, Rotation, Origin, Scale, Effects, Depth);
        }

        private void UpdateDepth()
        {
            Depth = (GetYGround() - TestComponent.Horizon) / (720 - TestComponent.Horizon);
        }
        protected virtual float GetYGround()
        {
            return Position.Y;
        }
